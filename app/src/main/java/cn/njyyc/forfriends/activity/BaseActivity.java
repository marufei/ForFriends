...
import cn.njyyc.forfriends.utils.OSHelper;
import cn.njyyc.forfriends.utils.ToolUtils;
    ...
    public void ToolBarStyle(int type) {
        switch (type) {
            case 0:
                ...
                ((ImageButton) findViewById(R.id.back)).setImageResource(R.mipmap.arrow_left);
